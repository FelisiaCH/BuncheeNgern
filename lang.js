...
const I18N = {
  ...
  placeholderScriptUrl:  { lo:'ວາງລິ້ງເຕັມ ຫຼື ວາງສະເພາະ Token', th:'วางลิงก์เต็ม หรือวางเฉพาะ Token', en:'Paste the full URL, or just the Token', vi:'Dán URL đầy đủ hoặc chỉ dán Token', my:'URL အပြည့်အစုံ သို့မဟုတ် Token ကိုသာ ကူးထည့်ပါ' },
  btnSaveScript:         { lo:'ບັນທຶກສະຄຣິບ', th:'บันทึกสคริปต์', en:'Save Script', vi:'Lưu Script', my:'Script သိမ်းမည်' },
  ...
  labelVapidKey:         { lo:'VAPID Public Key (ສຳລັບ Web Push)', th:'VAPID Public Key (สำหรับ Web Push)', en:'VAPID Public Key (for Web Push)', vi:'VAPID Public Key (dành cho Web Push)', my:'VAPID Public Key (Web Push အတွက်)' },
  placeholderVapidKey:   { lo:'ວາງ VAPID Public Key ຂອງທ່ານ', th:'วาง VAPID Public Key ของคุณ', en:'Paste your VAPID public key', vi:'Dán VAPID public key của bạn', my:'သင့် VAPID public key ကို ကူးထည့်ပါ' },
  btnSaveVapidKey:       { lo:'ບັນທຶກ VAPID Key', th:'บันทึก VAPID Key', en:'Save VAPID Key', vi:'Lưu VAPID Key', my:'VAPID Key သိမ်းမည်' },
  warnEnterVapidKey:     { lo:'⚠️ ກະລຸນາປ້ອນ VAPID Public Key', th:'⚠️ กรุณากรอก VAPID Public Key', en:'⚠️ Please enter a VAPID public key', vi:'⚠️ Vui lòng nhập VAPID public key', my:'⚠️ VAPID public key ကို ရိုက်ထည့်ပါ' },
  warnNoVapidKey:        { lo:'⚠️ ກະລຸນາບັນທຶກ VAPID Public Key ກ່ອນສະໝັກຮັບ', th:'⚠️ กรุณาบันทึก VAPID Public Key ก่อนสมัครรับการแจ้งเตือน', en:'⚠️ Please save a VAPID public key before subscribing', vi:'⚠️ Vui lòng lưu VAPID public key trước khi đăng ký', my:'⚠️ စာရင်းသွင်းမီ VAPID public key ကို သိမ်းပါ' },
  toastVapidSaved:       { lo:'✅ ບັນທຶກ VAPID Key ສຳເລັດ!', th:'✅ บันทึก VAPID Key สำเร็จ!', en:'✅ VAPID key saved!', vi:'✅ Đã lưu VAPID key!', my:'✅ VAPID key သိမ်းပြီးပါပြီ!' },
  ...
  menuActiveScript:      { lo:'ສະຄຣິບທີ່ໃຊ້ງານ', th:'สคริปต์ที่ใช้งาน', en:'Active Script', vi:'Script đang dùng', my:'အသုံးပြုနေသော Script' },
  menuCredentials:       { lo:'⚙️ ການຕັ້ງຄ່າ / Settings', th:'⚙️ ตั้งค่า / Settings', en:'⚙️ Settings', vi:'⚙️ Cài đặt / Settings', my:'⚙️ ဆက်တင် / Settings' },
  ...
  btnRequestNotifPermission: { lo:'🔑 ເປີດສິດແຈ້ງເຕືອນ / Request Permission', th:'🔑 เปิดสิทธิ์แจ้งเตือน / Request Permission', en:'🔑 Request Notification Permission', vi:'🔑 Yêu cầu quyền thông báo / Request Permission', my:'🔑 အသိပေးချက် ခွင့်ပြုချက်တောင်းမည် / Request Permission' },
  notifPermResultGranted:    { lo:'✅ ສະຖານະການອະນຸຍາດ: granted — ການແຈ້ງເຕືອນລະບົບສາມາດໃຊ້ງານໄດ້ແລ້ວ!', th:'✅ สถานะการอนุญาต: granted — ตอนนี้การแจ้งเตือนระบบใช้งานได้แล้ว!', en:'✅ Permission status: granted — system notifications can now be used!', vi:'✅ Trạng thái quyền: granted — thông báo hệ thống có thể sử dụng ngay bây giờ!', my:'✅ ခွင့်ပြုချက်အခြေအနေ - granted — စနစ်အသိပေးချက်များ ယခု အသုံးပြုနိုင်ပါပြီ!' },
  notifPermResultDefault:    { lo:'ℹ️ ສະຖານະການອະນຸຍາດ: default — ທ່ານຍັງບໍ່ໄດ້ເລືອກອະນຸຍາດ ຫຼື ປະຕິເສດ', th:'ℹ️ สถานะการอนุญาต: default — คุณยังไม่ได้เลือกอนุญาตหรือปฏิเสธ', en:'ℹ️ Permission status: default — you have not chosen to allow or block yet', vi:'ℹ️ Trạng thái quyền: default — bạn chưa chọn cho phép hoặc chặn', my:'ℹ️ ခွင့်ပြုချက်အခြေအနေ - default — ခွင့်ပြုမည် သို့မဟုတ် ပိတ်မည်ကို မရွေးရသေးပါ' },
  notifPermResultDenied:     { lo:'🔒 ສະຖານະການອະນຸຍາດ: denied — ການແຈ້ງເຕືອນຖືກບລັອກໄວ້ ກະລຸນາແກ້ໄຂການຕັ້ງຄ່າເວັບໄຊ', th:'🔒 สถานะการอนุญาต: denied — การแจ้งเตือนถูกบล็อกไว้ กรุณาแก้ไขการตั้งค่าเว็บไซต์', en:'🔒 Permission status: denied — notifications are blocked; please fix the site settings', vi:'🔒 Trạng thái quyền: denied — thông báo đã bị chặn; vui lòng sửa cài đặt trang web', my:'🔒 ခွင့်ပြုချက်အခြေအနေ - denied — အသိပေးချက်များကို ပိတ်ထားသည်; site settings ကို ပြင်ပါ' },
